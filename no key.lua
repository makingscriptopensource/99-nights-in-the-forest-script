...
-- 1. All GUI creation (ScreenGui, Frame, Buttons, TextBox, etc.)
-- 2. All functions related to the key system (r4_0, r5_0, r6_0, r22_0, r23_0, r24_0, r25_0, r26_0)
-- 3. The logic to fetch and validate the key from pastebin.
-- 4. The initial check for a saved key.
-- The main script payload now runs directly.

-- == MAIN SCRIPT PAYLOAD ==
-- This is the code that originally ran only after a successful key check.
